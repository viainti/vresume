...
export const initialResumeStateEs = {
  ...
  education: [
    {
      ...
      gpa: "",
      description: `<ul>
        <li>Cursos relevantes: Estructuras de Datos, Algoritmos, Sistemas Operativos, Redes Computacionales, Desarrollo Web</li>
        <li>Top 5% de la clase, recibido honores de Lista del Decano durante tres años consecutivos</li>
        <li>Participé en proyectos de código abierto y obtuve certificaciones técnicas</li>
      </ul>`,
    },
  ],
  skillContent: `<div class="skill-content">
  <ul>
    <li>Frameworks Frontend: React, Vue.js, Next.js, Nuxt.js y otros frameworks SSR</li>
    <li>Lenguajes: TypeScript, JavaScript(ES6+), HTML5, CSS3</li>
    <li>UI/Estilos: TailwindCSS, Sass/Less, CSS Modules, Styled-components</li>
    <li>Gestión de Estado: Redux, Vuex, Zustand, Jotai, React Query</li>
    <li>Herramientas de Build: Webpack, Vite, Rollup, Babel, ESLint</li>
    <li>Testing: Jest, React Testing Library, Cypress</li>
    <li>Rendimiento: Principios de renderizado del navegador, métricas de rendimiento, code splitting, lazy loading</li>
    <li>Control de Versiones: Git, SVN</li>
    <li>Liderazgo Técnico: Experiencia en gestión de equipos, lideré selección tecnológica y arquitectura de proyectos grandes</li>
  </ul>
</div>`,
  selfEvaluationContent: "",
  experience: [
    {
      id: "1",
      company: "TechCorp MX",
      position: "Ingeniero Frontend Senior",
      date: "2021.07 - 2024.12",
      visible: true,
      details: `<ul>
      <li>Responsable del desarrollo y mantenimiento de la plataforma de creadores de contenido</li>
      <li>Optimicé la configuración de build, reduciendo el tiempo de compilación de 8 minutos a 2 minutos</li>
      <li>Diseñé e implementé biblioteca de componentes, aumentando la reutilización de código en 70%</li>
      <li>Lideré proyecto de optimización de rendimiento, reduciendo tiempo de carga en 50%</li>
      <li>Mentoricé ingenieros junior, organicé sesiones de compartir conocimiento técnico</li>
    </ul>`,
    },
  ],
  draggingProjectId: null,
  projects: [
    {
      id: "p1",
      name: "Plataforma de Gestión de Contenido",
      role: "Líder Frontend",
      date: "2022.06 - 2023.12",
      description: `<ul>
        <li>Plataforma de análisis de datos y gestión de contenido basada en React para millones de usuarios</li>
        <li>Sistema de análisis de datos, gestión de contenido y子系统 de ingresos</li>
        <li>Implementé Redux para gestión de estado, permitiendo manejo eficiente de flujos de datos complejos</li>
        <li>Usé biblioteca de componentes Ant Design para garantizar consistencia en UI</li>
        <li>Estrategias de code splitting y lazy loading para optimizar rendimiento</li>
      </ul>`,
      visible: true,
    },
    {
      ...
      date: "2020.03 - 2021.06",
      description: `<ul>
        <li>Solución integral para desarrollo, depuración y publicación de aplicaciones</li>
        <li>Aplicación de escritorio multiplataforma construida con Electron</li>
        <li>Soporta múltiples plataformas incluyendo Windows, macOS y Linux</li>
        <li>Proporciona logs de errores en tiempo real y herramientas de análisis de rendimiento</li>
      </ul>`,
      visible: true,
    },
    {
      id: "p3",
      name: "Plataforma de Monitoreo",
      role: "Líder Técnico",
      date: "2021.09 - 2022.05",
      description: `<ul>
        <li>Solución completa de monitoreo frontend incluyendo seguimiento de errores, monitoreo de rendimiento y análisis de comportamiento</li>
        <li>Construida con Vue y Element UI, proporcionando datos de monitoreo en tiempo real</li>
        <li>Soporta varias métricas incluyendo logs de errores, indicadores de rendimiento</li>
        <li>Proporciona herramientas detalladas para identificar y optimizar problemas</li>
      </ul>`,
      visible: true,
    },
  ],
...
export const blankResumeStateEs = {
  ...initialResumeStateEs,
  title: "Nuevo Currículum",
  basic: {
    ...initialResumeStateEs.basic,
    name: "",
    title: "",
    email: "",
    phone: "",
  ...
  projects: [],
  certificates: [],
  menuSections: [initialResumeStateEs.menuSections[0]],
};
