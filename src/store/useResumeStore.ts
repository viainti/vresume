  ...
  persist<ResumeStore>(
    (set, get) => ({
      ...
      createResume: (templateId = null, isBlank = false) => {
        ...
        if (isBlank) {
          initialResumeData =
            locale === "en" ? blankResumeStateEn : blankResumeStateEs;
        } else {
          initialResumeData =
            locale === "en" ? initialResumeStateEn : initialResumeStateEs;
        }
        ...
        const newResume: ResumeData = {
          ...
          title: `${locale === "en" ? "New Resume" : "Nuevo Currículum"} ${id.slice(
            0,
            6
          )}`,
        };
