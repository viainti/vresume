...
const SEO_BASE_URL = "https://vresume.app";
...
function getLocaleSeo(locale: Locale) {
  ...
  const localeTag = locale === "en" ? "en_US" : "es_ES";
  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:site_name", content: "VResume" },
      ...
      links: [
        ...
        { rel: "alternate", hrefLang: "x-default", href: `${SEO_BASE_URL}/es` }
      ]
    };
  },
