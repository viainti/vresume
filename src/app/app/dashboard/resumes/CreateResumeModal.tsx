...
import { initialResumeState, initialResumeStateEn, initialResumeStateEs } from "@/config/initialResumeData";
...
export const CreateResumeModal = ({
    ...
    const baseData = locale === "en" ? initialResumeStateEn : locale === "es" ? initialResumeStateEs : initialResumeState;
                            ...
                            >
                                ...
                                <div className="flex-1 relative bg-gray-50 dark:bg-gray-900/50 flex flex-col items-center justify-center p-8 sm:p-12 h-full overflow-hidden">
                                    ...
                                    >
                                        ...
                                        >
                                            <TemplateThumbnail template={previewTarget} t={t} quality="high" scaleModifier={1} baseData={baseData} />
                                        </motion.div>
                                    </motion.div>
                                </div>
